...
// import HeaderCover from "./images/cover5.jpg"
  ...
  render() {
    ...
    return (
      <header id="home" style={{ height: window.innerHeight - 100, display: 'block' }}>
        <a href="https://github.com/Mohammad-Abdul-Ghafour/Potrfolio-Template" target="_blank" rel="noreferrer" className="github-corner" aria-label="View source on GitHub">
        ...
        <div style={{ width: '100%', position: 'absolute' }}>
          <div style={{width:'45%',margin:'auto',marginTop:'-11%'}}>
